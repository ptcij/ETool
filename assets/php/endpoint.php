...
if ($method == "POST") {
    ...
    // get what are we uploading for
    switch($_POST["uploadFor"]) {
        case "moderator-profile-pic" :
            $folder = $_SERVER['DOCUMENT_ROOT'] . "/assets/img/moderators/";
            break;
	case "citizen-profile-pic" :
	    $folder = $_SERVER['DOCUMENT_ROOT'] . "/assets/img/citizens/";
            break;
        default:
            return;
    }
    ...
    if($folder === "") {
        header("HTTP/1.0 405 Folder is not specified.");
    }
