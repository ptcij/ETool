                    ...
                    <table role='presentation' cellspacing='0' cellpadding='0' border='0' align='center' width='600' style='margin: auto;' class='email-container'>
                        <tr>
                            <td style='padding: 20px 0; text-align: center'>
                                <img src='http://firstplanet.starfolk.tech/assets/img/graphics/firstplanetbanner.png' 
                                     width='200' height='50' alt='alt_text' border='0' 
                                     style='height: auto; font-family: sans-serif; 
                                     font-size: 15px; line-height: 20px; color: #555555;'>
                            </td>
                        </tr>
                    </table>
                    <!-- Email Header : END -->
                                ...
                                <table role='presentation' cellspacing='0' cellpadding='0' border='0' align='center' style='margin: auto'>
                                    <tr>
                                        <td style='border-radius: 3px; background: #222222; text-align: center;' class='button-td'>
                                            <a href='$btn_href' style='background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;' class='button-a'>
                                                &nbsp;&nbsp;&nbsp;&nbsp;<span style='color:#ffffff;'>$btn_name</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                            </a>
                                        </td>
                                    </tr>
                                </table>
